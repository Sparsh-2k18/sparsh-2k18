...
FlipDown.prototype.init = function() {
  ...
  this.daysremaining = Math.floor((this.epoch - this.now) / 8640000).toString().length;
  ...
  var dayRotors = [];
  for(var i = 0; i < dayRotorCount-1; i++) {
...
FlipDown.prototype.tick = function() {
  ...
  // Days remaining
  this.clockValues.d = Math.floor(diff / 86400000);
  //diff -= this.clockValues.d * 86400000;

  // Hours remaining
  this.clockValues.h = Math.floor((diff%86400000) / 3600000);
  //diff -= this.clockValues.h * 3600000;

  // Minutes remaining
  this.clockValues.m = Math.floor((diff%3600000) / 60000);
 // diff -= this.clockValues.m * 60000;

  // Seconds remaining
  this.clockValues.s = Math.floor((diff%60000)/1000);
